...
public class ParkingSpotController {
    ...
    public ResponseEntity<Object> saveParkingSpot(@RequestBody @Valid ParkingSpotDto parkingSpotDto) {
        //é possível criar validações customizadas das verificações abaixo
        if (parkingSpotService.existsByLicensePlate(parkingSpotDto.getLicensePlate())){
            ...
            return ResponseEntity.status(HttpStatus.CONFLICT).body("This unity already has a parking spot!");
        }
